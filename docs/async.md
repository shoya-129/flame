# Concurrency and Async in Wren

Wren provides a powerful model for concurrent programming using `async`, `await`, and `spawn`. Under the hood, these concepts map directly to Rust's lightweight futures and tasks.
