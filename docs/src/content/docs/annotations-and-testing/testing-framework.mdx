...
When writing complex integration tests for robotics control loops or validating edge-case state transitions, standard equality assertions (`assert_eq`) may not express custom branching failure logic clearly. 
